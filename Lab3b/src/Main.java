...
//1Spining
        ...
        rotatingPolygon6.setScale(2*a,2*a).setColor(Color.BLACK); //prawy prawe kolo
        ...
        rotatingPolygon5.setScale(2*a,2*a).setColor(Color.BLACK); //prawy lewe kolo
        world.add(rotatingPolygon5);

        staticRect3 =new TransformedObject(filledRect); //prawy ramie™
        staticRect3.setTranslation(1.5,1.8);
        staticRect3.setScale(2*a,0.1*a);
        staticRect3.setRotation(-20);

        staticRect3.setColor(Color.ORANGE); //prawy ramie
        world.add(staticRect3);

        staticTriangle3 = new TransformedObject(filledTriangle); //prawy trojkat
